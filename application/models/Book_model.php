...
var $column_order = array('name', 'category_id', 'ISBN', 'author', 'publisher', 'price', 'description', 'discount', 'published_date',null);
//set column field database for datatable orderable
var $column_search = array('name','author','publisher','discount');
