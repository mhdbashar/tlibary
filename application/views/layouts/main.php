        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-lg">TLibrary</span>
                </a>
                        ...
                        <!-- User Account: style can be found in dropdown.less -->
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"><?php echo $this->session->userdata('Ad_name'); ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <p>
                                        <?php echo $this->session->userdata('Ag_name'); ?>
                                        <small>Admin</small>
                                    </p>
                                    </li>
                                    <!-- Menu Footer-->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p><?php echo $this->session->userdata('Ad_name'); ?></p>
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('order/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('order/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li>
						<li>
            ...
            <footer class="main-footer">
                <strong>Developed By <a href="http://www.crudigniter.com/">TLibrary</a> 1.0</strong>
            </footer>
