				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="username" value="<?php echo ($this->input->post('username') ? $this->input->post('username') : $order['username']); ?>" class="form-control" id="username" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="create_date" value="<?php echo ($this->input->post('create_date') ? $this->input->post('create_date') : $order['create_date']); ?>" class="form-control" id="create_date" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="order_description" class="control-label">Order Description</label>
						<div class="form-group">
							<textarea name="order_description" class="form-control" id="order_description"><?php echo ($this->input->post('order_description') ? $this->input->post('order_description') : $order['order_description']); ?></textarea>
						</div>
					</div>
				</div>
			</div>
